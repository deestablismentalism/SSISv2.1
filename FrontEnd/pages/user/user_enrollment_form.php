...
<html lang="en">
    ...
    <link rel="stylesheet" href="../../assets/css/user/user-enrollment-form.css" media="all">
    <link rel="stylesheet" href="../../assets/css/user/user-enrollment-form-errors.css" media="all">
    <link rel="stylesheet" href="../../assets/css/user/user-enrollment-form-mq.css" media="all">
    <link rel="stylesheet" href="../../assets/css/fonts.css">
    <link rel="stylesheet" href="../../assets/css/reset.css">
</head>
<body>
<?php
    include_once __DIR__ . '/./user_base_designs.php';
?>
    ...
    <script src="../../assets/js/user/user-enrollment-form.js" defer></script>
</body>
</html>
