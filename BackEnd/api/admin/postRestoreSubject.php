...
require_once __DIR__ . '/../../admin/models/adminSubjectsModel.php';
...
try {
    ...
    $subjects = new adminSubjectsModel();
    $response = $subjects->restoreSubject($subjectId);
    if(!$response) {
        echo json_encode(['success'=> false,'message'=> 'Subject was not restored']);
        exit();
    }
    echo json_encode(['success'=> true,'message'=>'Subject restored successfully']);
    exit();
}
